...
const doorColorTexture = textureLoaders.load("./textures/door/color.jpg");
const doorAlphaTexture = textureLoaders.load("./textures/door/alpha.jpg");
const doorAmbientOcclusionTexture = textureLoaders.load(
  "./textures/door/ambientOcclusion.jpg"
);
const doorHeightTexture = textureLoaders.load("./textures/door/height.jpg");
const doorNormalTexture = textureLoaders.load("./textures/door/normal.jpg");
const doorMetalnessTexture = textureLoaders.load(
  "./textures/door/metalness.jpg"
);
const doorRoughnessTexture = textureLoaders.load(
  "./textures/door/roughness.jpg"
);
const matcapTexture = textureLoaders.load("./textures/matcaps/1.png ");
